...
class Down3(nn.Module):
    def __init__(self, in_size, out_size,stride=2,padding=1,dilation=1):
        ...
        self.conv1 = conv2DBatchNormRelu(in_size, out_size, 3, 1, padding=padding,dilation=dilation)
        self.conv2 = conv2DBatchNormRelu(out_size, out_size, 3, 1, padding=padding,dilation=dilation)
        self.conv3 = conv2DBatchNormRelu(out_size, out_size, 3, 1, padding=padding,dilation=dilation)
