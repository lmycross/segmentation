...
def train_model(model, criterion, optimizer, base_lr, num_epochs,
    ...
    for epoch in range(num_epochs):
        ...
        for j, data in enumerate(train_dataset):
            ...
            lr_ = lr_poly(base_lr,
                          epoch * len(train_dataset) + j, max_iter, 0.9)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--batch_size', nargs='?', type=int, default=2, help='Batch size')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='Weight decay')
    parser.add_argument(
        '--momentum', nargs='?', type=float, default=0.9, help='momentum')
    parser.add_argument(
        '--save_folder',
        nargs='?',
        type=str,
